...
public class BlackListService extends Service {
    ...
    public void onCreate() {
        mDao = BlackListDao.getInstence(getApplicationContext());
    ...
    class InnerSmsReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            for (Object object : objects) {
                ...
                //4,获取短信对象的基本信息
                String originatingPhone = sms.getOriginatingAddress();
                String messageBody = sms.getMessageBody();

                int mode = mDao.getMode(originatingPhone);
    ...
    public void endCall(String phone) {
        ...
        if (mode == 2 || mode == 3) {
            ...
            try {
                ...
                //3,反射调用此方法   getService是今天方法，不需要对象
            ...
            //6,在内容解析器上,去注册内容观察者,通过内容观察者,观察数据库(Uri决定那张表那个库)的变化 --> 内容观察者
